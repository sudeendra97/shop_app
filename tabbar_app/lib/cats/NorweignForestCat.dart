...
class NorweignForestCat extends StatefulWidget {
  @override
  State<NorweignForestCat> createState() => _NorweignForestCatState();
}

class _NorweignForestCatState extends State<NorweignForestCat> {
  final image = [
    Image.asset(
